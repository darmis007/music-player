...
function addMusic(title, artist, duration, i) {

    tableEl = document.getElementById("table-body")
    tableRowEl = document.createElement("tr", { ondblclick: `playSong(${i})` })
    tableRowEl.innerHTML = `<td>${title}</td><td>${artist}</td><td>${secondsToTime(duration)}</td>`
